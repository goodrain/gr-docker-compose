...
try: import yaml, yaml.constructor, yaml.representer, yaml.dumper
...
class OrderedRepresenter(yaml.representer.SafeRepresenter):

    def __init__(self, *args, **kwargs):
        super(OrderedRepresenter, self).__init__(*args, **kwargs)
...
class OrderedDumper(yaml.dumper.SafeDumper, OrderedRepresenter):
    ...
    def __init__(self, stream,
        ...
        yaml.dumper.SafeDumper.__init__(self, stream,
            ...
            **kwargs)
        OrderedRepresenter.__init__(self, default_style=default_style,
...
class AttrDict(OrderedDict):
    ...
    def dump(self, stream):
        ...
        yaml.dump( self, stream, Dumper=OrderedDumper,
